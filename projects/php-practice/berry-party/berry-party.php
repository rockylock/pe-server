...
$message = $guests . " guests will be attending the party. Each guest should have $berries berries. We'll need $totalBerries berries for the party, including the host, $host. There are $berriesPerBox berries in each package, with each package costing $" . $boxCost . ". So, we should purchase " . $boxQuantity . " boxes, for a total of $" . $totalCost . ".";
